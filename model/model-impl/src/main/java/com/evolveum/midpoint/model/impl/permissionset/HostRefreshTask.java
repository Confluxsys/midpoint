...
@Component
public class HostRefreshTask implements TaskHandler{

    public static final String HANDLER_URI = "http://midpoint.evolveum.com/xml/ns/public/model/idmphostrefresh/handler-3";
    ...
    private static final transient Trace LOGGER = TraceManager.getTrace(HostRefreshTask.class);
    ...
    public TaskRunResult run(Task task) {
        LOGGER.trace(HostRefreshTask.class + " task starting");
